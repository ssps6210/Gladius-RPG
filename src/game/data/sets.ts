...
export const ITEM_SETS: SetDefinition[] = [
  {
    ...
    bonuses: [
      { pieces: 2, description: "攻擊+8，防禦+5", descriptionEn: "ATK+8, DEF+5", effect: { attack: 8, defense: 5 } },
      { pieces: 3, description: "最大HP+40，傷害減免8%", descriptionEn: "Max HP+40, 8% dmg reduction", effect: { hp: 40, damageReduction: 8 } },
      { pieces: 4, description: "攻擊+15，吸血5%", descriptionEn: "ATK+15, 5% lifesteal", effect: { attack: 15, lifesteal: 5 } },
    ],
  },
  {
    id: "shadow",
    ...
    bonuses: [
      { pieces: 2, description: "速度+6，攻擊+5", descriptionEn: "SPD+6, ATK+5", effect: { speed: 6, attack: 5 } },
      { pieces: 3, description: "爆擊機率+10%，速度+4", descriptionEn: "+10% crit, SPD+4", effect: { critChance: 10, speed: 4 } },
      { pieces: 4, description: "攻擊+12，經驗+15%", descriptionEn: "ATK+12, +15% EXP", effect: { attack: 12, expBonus: 15 } },
    ],
  },
  {
    id: "iron",
    ...
    bonuses: [
      { pieces: 2, description: "防禦+10，最大HP+20", descriptionEn: "DEF+10, Max HP+20", effect: { defense: 10, hp: 20 } },
      { pieces: 3, description: "防禦+15，傷害減免10%", descriptionEn: "DEF+15, 10% dmg reduction", effect: { defense: 15, damageReduction: 10 } },
      { pieces: 4, description: "最大HP+60，防禦+10", descriptionEn: "Max HP+60, DEF+10", effect: { hp: 60, defense: 10 } },
      { pieces: 5, description: "吸血8%，攻擊+10", descriptionEn: "8% lifesteal, ATK+10", effect: { lifesteal: 8, attack: 10 } },
    ],
  },
  {
    id: "holy",
    ...
    bonuses: [
      { pieces: 2, description: "最大HP+30，攻擊+6", descriptionEn: "Max HP+30, ATK+6", effect: { hp: 30, attack: 6 } },
      { pieces: 3, description: "吸血8%，經驗+10%", descriptionEn: "8% lifesteal, +10% EXP", effect: { lifesteal: 8, expBonus: 10 } },
      { pieces: 4, description: "攻擊+18，爆擊機率+8%", descriptionEn: "ATK+18, +8% crit", effect: { attack: 18, critChance: 8 } },
    ],
  },
  {
    id: "berserker",
    ...
    bonuses: [
      { pieces: 2, description: "攻擊+10，速度+3", descriptionEn: "ATK+10, SPD+3", effect: { attack: 10, speed: 3 } },
      { pieces: 3, description: "爆擊機率+12%，攻擊+8", descriptionEn: "+12% crit, ATK+8", effect: { critChance: 12, attack: 8 } },
      { pieces: 4, description: "吸血10%，速度+5", descriptionEn: "10% lifesteal, SPD+5", effect: { lifesteal: 10, speed: 5 } },
      { pieces: 5, description: "攻擊+20，經驗+20%", descriptionEn: "ATK+20, +20% EXP", effect: { attack: 20, expBonus: 20 } },
    ],
  },
  {
    id: "death",
    ...
    bonuses: [
      { pieces: 2, description: "攻擊+10，吸血5%", descriptionEn: "ATK+10, 5% lifesteal", effect: { attack: 10, lifesteal: 5 } },
      { pieces: 3, description: "爆擊機率+10%，攻擊+12", descriptionEn: "+10% crit, ATK+12", effect: { critChance: 10, attack: 12 } },
      { pieces: 4, description: "吸血12%，傷害減免5%", descriptionEn: "12% lifesteal, 5% dmg reduction", effect: { lifesteal: 12, damageReduction: 5 } },
    ],
  },
];
