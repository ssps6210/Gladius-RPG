export const MERC_BASES: Array<Record<string, any>> = [
  ...
  { id: "paladin", name: "聖騎士", nameEn: "Paladin", icon: "⚜️", attack: 12, defense: 15, hp: 120, heal: 5, desc: "聖護：防禦+回血", descEn: "Holy: DEF + heal", grade: "mythic" },
  { id: "assassin", name: "暗殺者", nameEn: "Assassin", icon: "🌑", attack: 30, defense: 2, hp: 30, heal: 0, desc: "暗殺：首攻×2", descEn: "Assassinate: first hit ×2", grade: "mythic" },
];

export const MERC_SCROLL_AFFIXES: Array<Record<string, any>> = [
  { id: "ms_atk", tag: "勇武", tagEn: "Valor", stat: "attack", min: 3, max: 15 },
  { id: "ms_def", tag: "堅壁", tagEn: "Bulwark", stat: "defense", min: 2, max: 10 },
  { id: "ms_hp", tag: "強健", tagEn: "Vigor", stat: "hp", min: 10, max: 50 },
  { id: "ms_heal", tag: "治癒", tagEn: "Healing", stat: "heal", min: 1, max: 6 },
  { id: "ms_all", tag: "精英", tagEn: "Elite", special: "all", val: 0.15 },
  { id: "ms_first", tag: "先鋒", tagEn: "Vanguard", special: "first", val: 0.25 },
];

export const MERC_DUNGEONS: Array<Record<string, any>> = [
  {
    id: "m1", label: "城鎮清剿", labelEn: "Town Raid", icon: "🏘️", minLv: 1, lvBonus: 0,
    ...
    boss: { name: "盜賊首領", nameEn: "Bandit Chief", icon: "🗡️", hpM: 2.0, atkM: 1.5, defM: 1.0, trait: "dodge" },
    reward: { expMult: 1.2, goldMult: 1.5, scrollBonus: 0.20 },
  },
  {
    id: "m2", label: "礦坑奪寶", labelEn: "Mine Heist", icon: "⛏️", minLv: 3, lvBonus: 2,
    ...
    boss: { name: "巨型石魔", nameEn: "Mega Stone Demon", icon: "🪨", hpM: 3.0, atkM: 1.4, defM: 2.5, trait: "armor" },
    reward: { expMult: 1.4, goldMult: 2.0, scrollBonus: 0.30 },
  },
  {
    id: "m3", label: "神殿淨化", labelEn: "Temple Purge", icon: "🏛️", minLv: 6, lvBonus: 4,
    ...
    boss: { name: "大惡魔君主", nameEn: "Demon Lord", icon: "👿", hpM: 3.5, atkM: 2.0, defM: 1.2, trait: "fire" },
    reward: { expMult: 1.8, goldMult: 2.5, scrollBonus: 0.40 },
  },
  {
    id: "m4", label: "龍巢突襲", labelEn: "Dragon Lair Raid", icon: "🐉", minLv: 10, lvBonus: 6,
    ...
    boss: { name: "龍騎將軍", nameEn: "Dragon Knight General", icon: "⚔️", hpM: 4.0, atkM: 2.2, defM: 1.8, trait: "dragonArmor" },
    reward: { expMult: 2.2, goldMult: 3.0, scrollBonus: 0.50 },
  },
  {
    id: "m5", label: "虛空入侵", labelEn: "Void Invasion", icon: "🌀", minLv: 15, lvBonus: 10,
    ...
    boss: { name: "虛空先驅", nameEn: "Void Herald", icon: "🌑", hpM: 4.5, atkM: 2.5, defM: 2.0, trait: "voidRip" },
