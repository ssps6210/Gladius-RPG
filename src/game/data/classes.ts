...
export const JOB_CLASSES: Record<JobClassId, JobClass> = {
  ...
  paladin: {
    ...
    desc: "+25攻擊 +30防禦 +20%HP。格擋率強化至30%，格擋時反彈30%傷害給敵方。",
    descEn: "+25 ATK +30 DEF +20% HP. Block upgraded to 30%; reflect 30% damage on block.",
  },
  assassin: {
    ...
    desc: "+30攻擊 +15速度。繼承：首回合必定爆擊。爆擊率+20%，爆擊傷害強化至×3.5。",
    descEn: "+30 ATK +15 SPD. Inherits: first-round crit. +20% crit chance. Crit upgraded to ×3.5.",
  },
  shadowFiend: {
